...
![Version](https://img.shields.io/badge/version-3.4.2-red?style=for-the-badge)
...
#### Generation 5: Dimension validation for OG images (v3.4.2)
...
| v3.4.2 | + OG dimension validation (header bytes) | ~97% | Catches portrait OG images with landscape URLs |
...
| 3.4.0 | Portrait OG images accepted | Close-cropped face shots despite URL validation | Portrait images with landscape CDN URLs slip through regex | Header byte inspection for actual dimensions (v3.4.2) |
